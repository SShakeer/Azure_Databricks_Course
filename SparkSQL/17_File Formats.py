...
df=spark.read.format("parquet").option("header","true").option("inferSchema","true").load("/mnt/data/emp.parquet")

# COMMAND ----------

df.write.format("parquet").mode("overwrite").save("emp.parquet")
